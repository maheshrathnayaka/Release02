    ...
    <body class="body-custom">
        ...
        <div class="container cont-cust">
            ...
            <div class="panel panel-info col-lg-9" style="padding: 0px; margin-left: 20px;">
                <div class="panel-heading">
                    <h3 class="panel-title">Items by seller</h3>
                </div>
                <div class="panel-body" style="padding-left: 5px; padding-right: 5px;">
                    <form role="form" class="form" method="POST" action="<?php echo base_url(); ?>advanced_search/search_items_by_name">
                        <div class="form-group form-horizontal">
                            <label for="InputKeyword">Enter seller's name</label>
                            <input type="text" name="seller_name" required class="form-control col-lg-9" id="InputKeyword" placeholder="Enter seller name...">
                        </div>
